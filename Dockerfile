...
ENV LIVY_VERSION_STRING=livy-${LIVY_VERSION}-incubating-bin
ENV SPARK_HOME=/spark
ENV LIVY_HOME=/livy

RUN wget http://apache.mirror.iphh.net/spark/spark-${SPARK_VERSION}/${SPARK_VERSION_STRING}.tgz \
	&& wget http://ftp.jaist.ac.jp/pub/apache/incubator/livy/${LIVY_VERSION}-incubating/${LIVY_VERSION_STRING}.zip
